...
// Importar Alpine.js desde CDN en lugar de módulo
...
// Configurar Alpine.js cuando esté disponible
document.addEventListener('alpine:init', function () {
  // Registrar componentes globales
  if (window.Alpine) {
    window.Alpine.data('transactionsComponent', transactionsComponent);
    window.Alpine.data('reportComponent', reportComponent);
    window.Alpine.data('financialAdviceComponent', financialAdviceComponent);
  }
});
...
function _initializeApp() {
  _initializeApp = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var currentPage, publicPages, isPublicPage;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          currentPage = window.location.pathname.split('/').pop() || 'index.html'; // Verificar si estamos en una página pública
          publicPages = ['signin.html', 'signup.html', 'landing.html'];
          isPublicPage = publicPages.includes(currentPage); // Solo verificar autenticación si no estamos en una página pública
          if (isPublicPage) {
            _context.next = 8;
            break;
          }
        ...
        case 21:
          ...
          console.error('Error inicializando la aplicación:', _context.t0);
        case 24:
        case "end":
...
function initializeDashboard() {
  return _initializeDashboard.apply(this, arguments);
} // Inicializar página de transacciones
function _initializeDashboard() {
  _initializeDashboard = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var latestTransactions, formattedTransactions;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return loadCurrentMonthMetrics();
        case 3:
          _context2.next = 5;
          return transactionService.getLatestTransactions();
        case 5:
          latestTransactions = _context2.sent;
          if (latestTransactions.length > 0) {
            formattedTransactions = latestTransactions.map(function (t) {
              return transactionService.formatTransactionForUI(t);
            });
        ...
        case 11:
          ...
          console.error('Error inicializando dashboard:', _context2.t0);
...
function initializeTransactionsPage() {
  return _initializeTransactionsPage.apply(this, arguments);
} // Inicializar página de reportes
function _initializeTransactionsPage() {
  _initializeTransactionsPage = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var transactions;
      ...
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          ...
          if (transactions.length > 0) {
            window.transactions = transactions.map(function (t) {
              return transactionService.formatTransactionForUI(t);
            });
        ...
        case 8:
          ...
          console.error('Error inicializando página de transacciones:', _context3.t0);
        case 11:
        case "end":
...
function initializeReportPage() {
  return _initializeReportPage.apply(this, arguments);
} // Inicializar Dropzone
function _initializeReportPage() {
  _initializeReportPage = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (copyInput) {
    ...
    copyButton.addEventListener("click", function () {
      ...
      navigator.clipboard.writeText(websiteInput.value).then(function () {
